...
def convert_folder_with_preds_back_to_BraTS_labeling_convention(input_folder: str, output_folder: str, num_processes: int = 12):
    """
    description: 必须是NIfTI类型! 读取文件夹下所有子文件夹中的文件
    """
...
if __name__ == '__main__':
    brats_data_dir = '/root/autodl-tmp/nnUNet/Dataset_raw/BraTS2021_Training_Data' # BraTS2021路径(BraTS2023亦适用)
    ...
    generate_dataset_json(out_base,
                          ...
                          labels={
                              ...
                              'tumor core': (2, 3),
                              'enhancing tumor': (3, )
                          }, # Region Based Train/非基于趋于参考Dataset725
